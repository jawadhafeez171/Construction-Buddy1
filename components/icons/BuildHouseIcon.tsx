...
const BuildHouseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg 
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 21h18M3 10.5h18M3 3.75h18" />
  </svg>
);

export default BuildHouseIcon;