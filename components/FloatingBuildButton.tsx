...
const FloatingBuildButton: React.FC = () => {
  ...
  return (
    <div
      className={`hidden md:block fixed bottom-6 left-1/2 -translate-x-1/2 z-[65] transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'
        }`}
    >
