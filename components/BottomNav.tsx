...
const NavItem: React.FC<{ to: string; icon: React.ReactNode; label: string; active: boolean }> = ({ to, icon, label, active }) => (
  <Link 
    to={to} 
    className={`group relative flex flex-col items-center justify-center min-w-[60px] py-1.5 transition-all duration-300 ${
  ...
  >
    ...
    {/* Label */}
    <span className={`relative z-10 text-[10px] font-medium mt-0.5 transition-all duration-300 ${
      active 
